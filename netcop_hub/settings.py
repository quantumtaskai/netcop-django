...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,testserver,netcop.up.railway.app,quantumtaskai.com,www.quantumtaskai.com,mr9d7q2k.up.railway.app,iab9bx5a.up.railway.app').split(',')
